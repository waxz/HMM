            ...
            for j in range(self.Fi.shape[1]):
                for h in range(self.Fi.shape[2]):
                    for k in range(self.Fi.shape[3]):
                        ...
                        self.Fi[i][j][h][k] = (Gama_[0][h][new_obs_k] * (Fi[i][j][0][k] + self.time_factor * (
                                delta(new_obs_k, k) * g_delta(i, j, 0, h) * Q_[0] - Fi[i][j][0][k]))) + \
                                              (Gama_[1][h][new_obs_k] * (Fi[i][j][1][k] + self.time_factor * (
                                                      delta(new_obs_k, k) * g_delta(i, j, 1, h) * Q_[1] - Fi[i][j][1][
                                                  k])))
...
# %%
data = [690.0, 686.0, 687.0, 686.0, 683.0, 684.0, 681.0, 678.0, 678.0, 675.0, 674.0, 673.0, 670.0, 667.0, 662.0, 662.0,
        660.0, 660.0, 658.0, 654.0, 652.0, 646.0, 592.0, 567.0, 573.0, 608.0, 623.0, 597.0, 532.0, 347.0, 811.0, 1418.0,
        1550.0, 1542.0, 1481.0, 1092.0, 345.0, 621.0, 616.0, 616.0, 617.0, 620.0, 560.0]
